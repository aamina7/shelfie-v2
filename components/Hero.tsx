          ...
          <div className="flex items-start justify-between gap-10">
            ...
            <div className="w-[60%] pt-10">
              <div className="overflow-hidden">
                <h1
                  ref={titleRef}
                  className="reveal-text text-[56px] leading-[0.95] text-[#1f1f1f] uppercase"
              ...
              <div className="reveal-sub">
                ...
                {/* UPDATED: Changed py-9 to py-11 and px-24 to px-28 for a fatter feel */}
                <button className="mt-10 rounded-full bg-[#c85f00] px-28 py-11 text-[14px] text-white font-bold uppercase tracking-tighter transition-transform hover:scale-105 active:scale-95 shadow-lg flex items-center justify-center">
